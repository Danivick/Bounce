    ...
    public class most_played_activity extends Activity {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.most_played);
            ...
            back_arrow = (ImageView) findViewById(R.id.back_arrowM);
            ...
            back_arrow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(most_played_activity.this, home_activity.class);
